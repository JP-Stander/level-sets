...
def levelset_median_smoother(image, pmax=3, nmax=2, pmin=1, method = 'median', connectivity=8,
    ...
    N, M = img.shape
    level_sets = measure.label(img+1,connectivity=1) #This function does not pick up a connected set with a value of 0
